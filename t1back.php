...
if (isset($_POST['has_master']) && $_POST['has_master'] == 'yes') {
    ...
    $sql = "INSERT INTO education (resume_id, Board, end_year, percentage, institute_name) 
            VALUES ('$resume_id', 'Master\'s', '$master_year', '$master_percentage', '$master_institute')";
    $conn->query($sql);
}
...
if (isset($_POST['has_bachelor']) && $_POST['has_bachelor'] == 'yes') {
    ...
    $sql = "INSERT INTO education (resume_id, Board, end_year, percentage, institute_name) 
            VALUES ('$resume_id', 'Bachelor\'s',  '$bachelor_year', '$bachelor_percentage', '$bachelor_institute')";
    $conn->query($sql);
}
...
$sql = "INSERT INTO education (resume_id, Board, end_year, percentage, institute_name) 
        VALUES ('$resume_id', 'Higher Secondary',  '$hs_year', '$hs_percentage', '$hs_school')";
$conn->query($sql);
